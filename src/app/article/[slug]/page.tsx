...
export async function generateMetadata({
  ...
  if (!article) return { title: "Not found — Prairie State Herald" };
  return {
    title: `${article.title} — Prairie State Herald`,
...
export default async function ArticlePage({
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <div
        className="prose mt-10 max-w-none prose-headings:font-display prose-a:text-accent prose-strong:text-foreground"
